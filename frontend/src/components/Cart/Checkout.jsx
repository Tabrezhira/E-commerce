...
function Checkout() {
    ...
    //Ensure cart is loaded befor proceeding
    useEffect(() => {
                ...
                <div className="mt-6">
                    {!CheckoutId ? (
                        ...
                        <div>
                            ...
                            {/* <PayPalButton amount={cart.totalPrice} onSuccess={handlePaymentSuccess} onError={(err) => console.log(err)}/> */}
                            {/* <button type="submit" onClick={handlePaymentSuccess()} className="w-full bg-black text-white py-3 rounded">Payment</button> */}
                            <button
  type="button"
  onClick={() =>
