  ...
  return (
    <div className='max-w-7xl mx-auto p-6'>
        ...
        {productsLoading || ordersLoading ? (
            <p>Loading ...</p>
        ) : productsError ? ( <p className='text-red-500'> Error fetching products:{productsError} </p>) : orderError ? ( <p className='text-red-500'> Error fetching orders: {orderError} </p>) : (
            ...
            <div className=' overflow-x-auto'>
                <table className='min-w-full text-left text-gray-500'>
                    ...
                    <tbody>
                        {orders.length > 0 ? (
                            orders.map((order) => (
                                // console.log(order.user?.name || "no Name")
