...
function NewArrivals() {
  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
        ...
        className={`container scrollbar-custom mx-auto overflow-x-scroll flex space-x-6 relative ${isDragging ? "cursor-grabbing" : "cursor-grab"} `}>
            {newArrivals.map((product) => (
                <div key={product._id} className='min-w-[100%] sm:min-w-[50%] lg:min-w-[30%] relative'>
                    <img draggable='false' className='w-full h-[500px] object-cover rounded-lg' src={product.images[0]?.url} alt={product.images?.altText || product.name}  />
